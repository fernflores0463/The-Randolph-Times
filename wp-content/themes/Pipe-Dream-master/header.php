...
<meta property="article:publisher" content="https://www.facebook.com/therandolphtimes" />
...
<?php endif; ?>
	...
	<script type="text/javascript">
	  ...
	  var _gaq = _gaq || [];
	  _gaq.push(['_setAccount', 'UA-44516630-2']);
	  _gaq.push(['_setDomainName', 'aprtimes.com']);
	...
	<script>
		window.fbAsyncInit = function() {
			FB.init({
				...
				channelUrl : '//www.aprtimes.com/channel.html', // Channel File
	...
	<header class="row" role="banner">
		...
		<h1 id="logo" class="span12">
			<a href="<? bloginfo( 'url' ); ?>/" title="<? bloginfo('name'); ?>">
				<img src="<? bloginfo( 'template_url' ); ?>/img/bupip.png" alt="<? bloginfo( 'name' ); ?> - <? bloginfo( 'description' ); ?>" />
			</a>
		</h1>
		<section id="search-social" class="span6 last">
			<div class="social">
				<a href="https://www.facebook.com/therandolphtimes" title="Follow The Randolph Times on Facebook"><img src="<? bloginfo( 'template_url' ); ?>/img/social/facebook.png" alt="Facebook Page" /></a>
				<!-- <a href="https://twitter.com/bupipedream" title="Follow The Times on Twitter"><img src="<? bloginfo( 'template_url' ); ?>/img/social/twitter.png" alt="Twitter Account" /></a>
				<a href="https://instagram.com/bupipedream" title="Follow The Times on Instagram"><img src="<? bloginfo( 'template_url' ); ?>/img/social/instagram.png" alt="Instagram Blog" /></a>-->
			</div>
			<form id="search" role="search" method="get" action="<? bloginfo( 'wpurl' ); ?>/">
				<input type="search" name="s" autocomplete="on" placeholder="Search The APR Times" value="<? get_search_query(); ?>" />
	...
	<nav class="row" role="navigation">
		<ul class="primary">
			<?php
				...
				$whitelist = array('opinion', 'feature');
		...
		<ul class="secondary">
			...
			<li><a href="<? bloginfo('wpurl'); ?>/login/" title="Login to your account writers!">LOGIN</a></li>
			...
			<li><a href="<? bloginfo('wpurl'); ?>/staff/" title="The Times Staff">Staff</a></li>
			<li><a href="<? bloginfo('wpurl'); ?>/print/" title="The Times in print">Print</a></li>
