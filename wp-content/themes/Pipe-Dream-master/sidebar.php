<div id="sidebar" class="span7 last">
	...
	<?php if( is_single() ): ?>
		<section id="fb-settings" class="sidebar-block">
			...
			<div id="fb-profile-details" class="clearfix">
				<p id="fb-name"></p>
				<p id="fb-login-status">Logged into The Randolph Times and Facebook</p>
				<ul>
	...
	<?php if( is_home() || is_category() ): ?>
		...
		<section class="sidebar-block sidebar-block-center">
			<div class="fb-like-box" data-href="https://www.facebook.com/therandolphtimes" data-width="292" data-height="185" data-show-faces="true" data-border-color="#cccccc" data-stream="false" data-header="false"></div>
		</section>
